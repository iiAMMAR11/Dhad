...
const grammarRules = [
  { id: 'gender', title: 'جنس المعدود', wrong: 'تم حذف ٣ رسالة', right: 'تم حذف ٣ رسائل',
    why: 'دالة جمع واحدة لا تعرف جنس الاسم، فتعطي صيغة المذكر لكل الكلمات.' },
  { id: 'definite', title: 'المعدود نكرة', wrong: 'حُذفت ٣ الملفات', right: 'حُذفت ٣ ملفات',
    why: 'نص الترجمة معرّف، فيلتصق بالعدد حين يُدمج معه ويكسر التركيب.' },
  { id: 'address', title: 'المخاطبة', wrong: 'احفظ التغييرات', right: 'حفظ التغييرات',
    why: 'فعل الأمر يخاطب مذكرًا وحده، والمصدر يخاطب الجميع.' },
  { id: 'punctuation', title: 'الترقيم', wrong: 'هل تريد حذف الملف?', right: 'هل تريد حذف الملف؟',
    why: 'علامات الإنجليزية تعبر مع الترجمة، وشكل العربية مختلف.' },
  { id: 'ordinal', title: 'الترتيب', wrong: 'الخطوة الثاني من ٣', right: 'الخطوة الثانية من ٣',
    why: 'قائمة ترتيبيات واحدة تُعاد على كل الأسماء، والترتيب يتبع جنس المعدود.' },
  { id: 'tanween', title: 'التنوين', wrong: 'شكراً لك', right: 'شكرًا لك',
