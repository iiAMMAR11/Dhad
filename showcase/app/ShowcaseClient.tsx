...
const grammarRules = [
  ...
  { id: 'hamza', title: 'همزة القطع', wrong: 'الغاء الطلب', right: 'إلغاء الطلب',
    why: 'الهمزة تسقط في الكتابة السريعة، وتبقى ساقطة في النص المنشور.' },
  ...
  { id: 'hundred', title: 'ما بعد المئة', wrong: '١٠٠ ملفات', right: '١٠٠ ملف',
    why: 'من ثلاثة إلى عشرة جمع، ومن مئة فصاعدًا يعود المعدود مفردًا.' },
  { id: 'taa', title: 'التاء المربوطة', wrong: 'مشاركه الملف', right: 'مشاركة الملف',
    why: 'الهاء تحل محل التاء فيتغير المعنى، ولا يلتقطها المدقق اللاتيني.' },
